...
public class RegExpServiceTest {
    ...
    void testGetPrecisionNumber() throws IOException {
        assertEquals("Вчера вечером со счета номер 4301 0234 2145 2140 был совершен перевод на счет 5042 2012 0532 2043 в размере 1 рублей. На счету осталось 2 рублей",
