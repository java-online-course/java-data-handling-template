...
public class TextServiceTest {
    ...
    void testRemoveString(String param1, String param2, String expected) {
        assertEquals(expected, textService.removeString(param1, param2), "Для входных параметров: " + param1 + " " + param2);
    }
    ...
    void testIsQuestionString(String param, boolean expected) {
        assertEquals(expected, textService.isQuestionString(param), "Для входого параметра: " + param);
    }
    ...
    void testConcatenate(String[] param, String expected) {
        assertEquals(expected, textService.concatenate(param), "Для входных параметров: " + Arrays.toString(param));
    }
    ...
    void testToJumpCase(String param, String expected) {
        assertEquals(expected, textService.toJumpCase(param), "Для входого параметра: " + param);
    }
